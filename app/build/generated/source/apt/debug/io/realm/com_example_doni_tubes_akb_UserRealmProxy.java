...
public class com_example_doni_tubes_akb_UserRealmProxy extends com.example.doni.tubes_akb.User
    implements RealmObjectProxy, com_example_doni_tubes_akb_UserRealmProxyInterface {
    ...
    com_example_doni_tubes_akb_UserRealmProxy() {
    ...
    public static com.example.doni.tubes_akb.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    ...
                    obj = new io.realm.com_example_doni_tubes_akb_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("nama")) {
                if (json.isNull("nama")) {
                    obj = (io.realm.com_example_doni_tubes_akb_UserRealmProxy) realm.createObjectInternal(com.example.doni.tubes_akb.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_example_doni_tubes_akb_UserRealmProxy) realm.createObjectInternal(com.example.doni.tubes_akb.User.class, json.getString("nama"), true, excludeFields);
                }
            } else {
        ...
        final com_example_doni_tubes_akb_UserRealmProxyInterface objProxy = (com_example_doni_tubes_akb_UserRealmProxyInterface) obj;
        if (json.has("nim")) {
            if (json.isNull("nim")) {
    ...
    private static com_example_doni_tubes_akb_UserRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        ...
        io.realm.com_example_doni_tubes_akb_UserRealmProxy obj = new io.realm.com_example_doni_tubes_akb_UserRealmProxy();
        objectContext.clear();
        return obj;
    }
    ...
    public static com.example.doni.tubes_akb.User copyOrUpdate(Realm realm, UserColumnInfo columnInfo, com.example.doni.tubes_akb.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (canUpdate) {
            Table table = realm.getTable(com.example.doni.tubes_akb.User.class);
            long pkColumnIndex = columnInfo.namaIndex;
            String value = ((com_example_doni_tubes_akb_UserRealmProxyInterface) object).realmGet$nama();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_example_doni_tubes_akb_UserRealmProxy();
    ...
    public static com.example.doni.tubes_akb.User copy(Realm realm, UserColumnInfo columnInfo, com.example.doni.tubes_akb.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_example_doni_tubes_akb_UserRealmProxyInterface realmObjectSource = (com_example_doni_tubes_akb_UserRealmProxyInterface) newObject;
        ...
        io.realm.com_example_doni_tubes_akb_UserRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.example.doni.tubes_akb.User object, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.example.doni.tubes_akb.User.class);
        long pkColumnIndex = columnInfo.namaIndex;
        String primaryKeyValue = ((com_example_doni_tubes_akb_UserRealmProxyInterface) object).realmGet$nama();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$nim = ((com_example_doni_tubes_akb_UserRealmProxyInterface) object).realmGet$nim();
        if (realmGet$nim != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nimIndex, rowIndex, realmGet$nim, false);
        }
        String realmGet$notelp = ((com_example_doni_tubes_akb_UserRealmProxyInterface) object).realmGet$notelp();
        if (realmGet$notelp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.notelpIndex, rowIndex, realmGet$notelp, false);
        }
        String realmGet$email = ((com_example_doni_tubes_akb_UserRealmProxyInterface) object).realmGet$email();
    ...
    public static com.example.doni.tubes_akb.User createDetachedCopy(com.example.doni.tubes_akb.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_example_doni_tubes_akb_UserRealmProxyInterface unmanagedCopy = (com_example_doni_tubes_akb_UserRealmProxyInterface) unmanagedObject;
        com_example_doni_tubes_akb_UserRealmProxyInterface realmSource = (com_example_doni_tubes_akb_UserRealmProxyInterface) realmObject;
    ...
    static com.example.doni.tubes_akb.User update(Realm realm, UserColumnInfo columnInfo, com.example.doni.tubes_akb.User realmObject, com.example.doni.tubes_akb.User newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_example_doni_tubes_akb_UserRealmProxyInterface realmObjectTarget = (com_example_doni_tubes_akb_UserRealmProxyInterface) realmObject;
        com_example_doni_tubes_akb_UserRealmProxyInterface realmObjectSource = (com_example_doni_tubes_akb_UserRealmProxyInterface) newObject;
        Table table = realm.getTable(com.example.doni.tubes_akb.User.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addString(columnInfo.namaIndex, realmObjectSource.realmGet$nama());
    ...
    public boolean equals(Object o) {
        ...
        com_example_doni_tubes_akb_UserRealmProxy aUser = (com_example_doni_tubes_akb_UserRealmProxy)o;
